/**
 * CipherKit — Lorem Ipsum Generator
 */
(function () {
  'use strict';
  ...
  root.innerHTML =
    ...
    +     '<div class="out-box"><div class="out-head"><div class="out-label">' + IC.play + ' <span>Lorem Ipsum</span></div><button type="button" class="copy-btn" id="btn-cp" aria-label="Copy">' + IC.copy + ' <span>Copy</span></button></div><pre class="out-body ph" id="t-result" style="white-space:pre-wrap;word-break:break-word" role="status" aria-live="polite">Click Generate\u2026</pre></div>'
    +   '</div>'
    + '</div>'
    + '</div>';
