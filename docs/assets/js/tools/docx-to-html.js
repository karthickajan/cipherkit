...
(function(){
  ...
  sty.textContent='.d2h-tabs{display:flex;gap:0;margin-bottom:12px}.d2h-tab{background:#1e1e1e;border:1px solid #333;padding:8px 18px;cursor:pointer;color:#ccc;font-family:inherit;font-size:.85rem;transition:all .15s}.d2h-tab:first-child{border-radius:6px 0 0 6px}.d2h-tab:last-child{border-radius:0 6px 6px 0}.d2h-tab.active{background:#b083f0;color:#0d0518;font-weight:600;border-color:#b083f0}.d2h-tab:hover:not(.active){background:#282828}.d2h-preview{background:#fff;color:#000;padding:16px;border-radius:4px;max-height:320px;overflow-y:auto;resize:vertical}.d2h-source{max-height:320px;overflow-y:auto;resize:vertical;white-space:pre-wrap;word-break:break-all;font-size:.82rem;line-height:1.6;padding:12px}';
