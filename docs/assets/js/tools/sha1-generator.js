...
(function () {
  ...
  root.innerHTML =
    ...
    +   '<div class="tc-head">'
    +     '<div class="tc-title"><div class="tc-icon tc-icon-amber">' + IC.hash + '</div><h2 id="h-heading">SHA-1 Generator</h2></div>'
    +     '<span class="tc-badge tc-badge-amber">SHA-1</span>'
    +   '</div>'
