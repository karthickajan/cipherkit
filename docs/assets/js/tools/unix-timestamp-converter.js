...
(function () {
  ...
  root.innerHTML =
    ...
    +     '<div class="out-box"><div class="out-head"><div class="out-label">' + IC.play + ' <span>Date Result</span></div><button type="button" class="copy-btn" id="btn-cp1" aria-label="Copy">' + IC.copy + ' <span>Copy</span></button></div><pre class="out-body mono ph" id="t-date-result" role="status">Date will appear here\u2026</pre></div>'
    ...
    +     '<div class="out-box"><div class="out-head"><div class="out-label">' + IC.play + ' <span>Timestamp Result</span></div><button type="button" class="copy-btn" id="btn-cp2" aria-label="Copy">' + IC.copy + ' <span>Copy</span></button></div><div class="out-body mono ph" id="t-ts-result" role="status">Timestamp will appear here\u2026</div></div>'
    +   '</div>'
    + '</div>'
    + '</div>';
