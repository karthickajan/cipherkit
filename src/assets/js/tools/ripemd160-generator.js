...
(function () {
  ...
  root.innerHTML =
    ...
    +     '<div class="out-box"><div class="out-head"><div class="out-label">' + IC.play + ' <span>RIPEMD-160 Hash</span></div><button type="button" class="copy-btn" id="btn-cp" aria-label="Copy hash">' + IC.copy + ' <span>Copy</span></button></div><div class="out-body mono ph" id="h-result" role="status" aria-live="polite">Hash will appear here\u2026</div></div>'
    +   '</div>'
    + '</div>'
    + '</div>';
