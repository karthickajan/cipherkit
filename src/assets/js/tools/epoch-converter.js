...
(function(){
  ...
  $('btn-to-epoch').addEventListener('click',function(){
    var v=$('t-date').value;$('t-err2').textContent='';$('t-err2').style.display='none';
    if(!v){$('t-err2').textContent='Select a date/time.';$('t-err2').style.display='block';return;}
    var d=new Date(v);if(isNaN(d)){$('t-err2').textContent='Invalid date.';$('t-err2').style.display='block';return;}
    var f=formatDate(d);
