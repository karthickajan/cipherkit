    ...
    <div class="footer-brand">
      ...
      <div style="margin-top:12px;display:flex;flex-direction:column;gap:8px;align-items:flex-start">
        ...
        <a href="https://dofollow.tools" target="_blank" rel="noopener noreferrer">
          <img src="https://dofollow.tools/badge/badge_transparent.svg" alt="Featured on Dofollow.Tools" width="200" height="54" style="height:36px;width:auto;display:block;opacity:0.85">
        </a>
      </div>
    </div>
