...
function buildHead({ pageTitle, metaDescription, canonicalPath, extraMeta = '', extraImgSrc = '', extraConnectSrc = '', extraFrameSrc = '' }) {
  ...
  <meta name="creator" content="CipherKit">
  <link rel="me" href="https://karthickajan.github.io">
...
function buildSchema(tool) {
  const webApp = {
    ...
    "featureList": "100% client-side, no server, no data upload, works offline",
    "author": { "@type": "Person", "name": "Karthick Ajan G S", "url": "https://karthickajan.github.io" },
    "creator": { "@type": "Organization", "name": "CipherKit", "url": DOMAIN }
  };
...
<main class="tool-page" id="main-content">
  ...
  <div class="tool-header">
    <div class="tool-header-inner">
      ...
      <h1>${tool.h1}</h1>
      <p class="tool-tagline">${tool.metaDescription} — runs 100% in your browser, client-side only. No data is sent to any server. Free to use, no account required.</p>
